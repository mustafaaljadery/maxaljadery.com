...
const research = [
  ...
  },
  {
    ...
    link: '/research/blockchain-analysis.pdf',
  },
];
  ...
  return (
    <>
      ...
      <main className="flex flex-col w-full justify-center items-center">
        <div className="w-1/2 flex flex-col mt-16">
            ...
            <div className="flex flex-col space-y-6 mt-8 w-full">
              {research.map((research: any, index: number) => {
                return (
                  <button
                    key={index}
                    className="flex flex-row p-2 hover:bg-gray-50 justify-between items-between w-full"
                  >
          ...
          <div className="mt-20 flex flex-col w-full">
            ...
            <p className="text-center mt-8 text-sm font-medium text-gray-700">
              No personal writing yet, but I plan to!
            </p>
          </div>
        </div>
      </main>
